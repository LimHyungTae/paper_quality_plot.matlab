...
%% Save (fig1)
exportgraphics(gcf, "SuccessRate1_quatro_pp.png", 'Resolution', 300);
exportgraphics(gcf, "SuccessRate1_quatro_pp.pdf", 'ContentType', 'vector');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Input data (fig2)
% (no additional data prep; reuses degen_s_lists from fig1's Input data block)
...
%% Drawing parameters (fig2)
% (reuses common_fontsize from fig1's Drawing parameters)
...
%% Save (fig2)
exportgraphics(gcf, "SuccessRate2_quatro_pp.png", 'Resolution', 300);
exportgraphics(gcf, "SuccessRate2_quatro_pp.pdf", 'ContentType', 'vector');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Input data (RANSAC10K)
...
%% Save (RANSAC10K)
exportgraphics(gcf, "RANSAC10K_success_rate.png", 'Resolution', 300);
exportgraphics(gcf, "RANSAC10K_success_rate.pdf", 'ContentType', 'vector');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Input data (FGR)
% (reuses X, flip_thresh, FGR_lists from earlier sections)

%% Drawing parameters (FGR)
% (reuses common_fontsize from fig1's Drawing parameters)
...
%% Save (FGR)
exportgraphics(gcf, "FGR_success_rate.png", 'Resolution', 300);
exportgraphics(gcf, "FGR_success_rate.pdf", 'ContentType', 'vector');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Input data (TEASER)
% (reuses X, flip_thresh, TEASER_lists from earlier sections)

%% Drawing parameters (TEASER)
% (reuses common_fontsize from fig1's Drawing parameters)
...
%% Save (TEASER)
exportgraphics(gcf, "TEASER_success_rate.png", 'Resolution', 300);
exportgraphics(gcf, "TEASER_success_rate.pdf", 'ContentType', 'vector');

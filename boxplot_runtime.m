...
ylabel('Optimization Time [s]', 'interpreter','latex', 'FontSize', YFontSize)
grid on;

%% Save
exportgraphics(gcf, "imgs/box_plot2_r300.png", 'Resolution', 300);
exportgraphics(gcf, "imgs/box_plot2_r300.pdf", 'ContentType', 'vector');

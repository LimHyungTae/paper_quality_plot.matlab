...
%% Save (maxclique)
    exportgraphics(gcf, "num_MC.png", 'Resolution', 300);
    exportgraphics(gcf, "num_MC.pdf", 'ContentType', 'vector');


%% Input data (rot_inlier)
X = categorical({'00', '02', '05', '06', '07', '08'});
...
%% Save (rot_inlier)
    exportgraphics(gcf, "num_rot_inlier.png", 'Resolution', 300);
    exportgraphics(gcf, "num_rot_inlier.pdf", 'ContentType', 'vector');

%% Input data (trans_inlier)
X = categorical({'00', '02', '05', '06', '07', '08'});
...
%% Drawing parameters (trans_inlier)
margin_x = 0.015;
margin_y = 2.8;
margin = -2.5;
common_fontsize = 32;
...
%% Save (trans_inlier)
    exportgraphics(gcf, "num_trans_inlier.png", 'Resolution', 300);
    exportgraphics(gcf, "num_trans_inlier.pdf", 'ContentType', 'vector');
